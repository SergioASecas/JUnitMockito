package com.example.mockito.demo.Modelo;
...
public class Datos {
    ...
    public final static List<String> PREGUNTAS = Arrays.asList("Aritmética", "integrales", "derivadas", "trigonometria", "geometria", "Español");   
